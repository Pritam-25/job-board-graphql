...
> = {
  applicants?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType>;
...
> = {
  applyToJob?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationApplyToJobArgs, 'input'>
  >;
  cancelApplication?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationCancelApplicationArgs, 'input'>
  >;
  createJob?: Resolver<
    ResolversTypes['Job'],
    ParentType,
...
> = {
  ...
  searchJobs?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerySearchJobsArgs, 'input'>
  >;
  users?: Resolver<
...
> = {
  ...
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  jobsOwned?: Resolver<Array<ResolversTypes['Job']>, ParentType, ContextType>;
